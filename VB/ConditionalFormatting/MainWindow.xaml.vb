...
Namespace ConditionalFormatting
	Partial Public Class MainWindow
		...
		Public Sub New()
			InitializeComponent()
			view.FormatConditions.AddRange(New List(Of FormatConditionBase) From {
				New FormatCondition() With {
				...
				New FormatCondition() With {
					...
					.FieldName = "Profit",
					.Format = New Format() With {.Foreground = Brushes.Red}
				},
				New DataBarFormatCondition() With {
					.FieldName = "Sales",
					.PredefinedFormatName = "RedGradientDataBar"
				},
				New TopBottomRuleFormatCondition() With {
					.Expression = "[Sales]",
					.FieldName = Nothing,
				...
				New IconSetFormatCondition() With {
